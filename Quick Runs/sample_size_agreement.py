...
MAX_CANOPY_COVER = 30 # Maximum total canopy cover percentages
INCREMENT_CANOPY_COVER = 5 # Increment between the canopy cover percentages

trials = 1 # Number of trials (bootstraps)
...
AOIS = {
    "Neighbourhood (20 km²)": (149, 149), # Neighbourhood (20 km²) AOI
    "City (400 km²)": (666, 666), # City (400 km²) AOI
    "Region (3,000 km²)": (1825, 1825), # Region / County (3,000 km²) AOI
}
